...
export default function DeleveryFee() {
    ...
    const displayitems = items.slice(PagesVisited, PagesVisited + itemsPerPage)
        .map((item) => {
            return <div className="delevery-fee items_contents" key={item.item_id}>
                ...
                <div className="body_header">
                    <nav>
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">Delevery Fee</li>
                        </ol>
                    </nav>
                </div>
